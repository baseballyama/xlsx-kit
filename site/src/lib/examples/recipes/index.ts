...
// file is type-checked against `xlsx-craft` on every build, so the
    ...
    recipes: [
      ...
      },
      {
        ...
        notes: [
          ...
          'For shared and array formulas, use `setSharedFormula` / `setArrayFormula` from `xlsx-craft/cell` on the Cell returned by `setCell`.',
        ],
