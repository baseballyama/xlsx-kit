...
<svelte:head>
  <title>ooxml-js — TypeScript port of openpyxl</title>
</svelte:head>
...
<section class="hero">
  <div class="hero-inner">
    ...
    <div class="cta">
      ...
      <a href="https://github.com/baseballyama/ooxml-js" class="btn">GitHub</a>
    </div>
    <p class="install"><code>pnpm add ooxml-js</code></p>
  </div>
</section>
...
<section class="features">
  <div class="features-inner">
    ...
    <article>
      ...
      <p>
        <code>ooxml-js</code> ≤ 120&nbsp;KB brotli (currently ~78&nbsp;KB).
        <code>ooxml-js/streaming</code> ≤ 80&nbsp;KB brotli (~47&nbsp;KB). All exports are
        side-effect-free.
      </p>
    </article>
  </div>
