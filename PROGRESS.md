...
- **次のタスク**: **workbook view toggles (`setShowHorizontalScroll` / `setShowVerticalScroll` / `setWorkbookMinimized` / `setWorkbookVisibility`) を追加**。primary workbookView の chrome 制御を 1-line で:
