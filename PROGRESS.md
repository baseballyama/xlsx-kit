...
- **次のタスク**: **format-preset cell helpers (`setCellAsCurrency` / `setCellAsPercent` / `setCellAsDate` / `setCellAsNumber`) を追加**。Excel "Format Cells → Number → Category" の preset を 1-line で:
