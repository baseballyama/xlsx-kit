...
```ts
// xlsx-kit
import { fromFile, loadWorkbook, saveWorkbook, toFile } from 'xlsx-kit/node';
...
If openpyxl preserves it, `xlsx-kit` does too — but typically without a
