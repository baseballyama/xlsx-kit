...
import { freezePaneRef, makeFreezePane, makeSheetView } from '../../src/xlsx/worksheet/views';
import { getFreezePanes, setCell, setFreezePanes, type Worksheet } from '../../src/xlsx/worksheet/worksheet';
